...
Do come in, [have a look around]({{ '/projects/' | url }}), and if you like what you see, consider [subscribing to my email list]({{ '/newsletter/' | url }}). I only send updates when I need to and never spam.
...
Please [reach out]({{ '/contact/' | url }}) anytime — I reply to every email.
